...
import styles from '../styles/headers/header-1.module.scss'
import { HeaderPhoto } from './HeaderPhoto'

export function renderHeader1({ data, block, marginBottom, onNavigate, helpers }: HeaderRenderProps) {
