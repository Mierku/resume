...
function DashboardWorkbenchInner() {
  ...
  return (
    <div className={styles.app} data-dashboard-theme="builder-aligned">
      ...
      <div data-dashboard-drawer="shell" className={cn(styles.drawerShell, mobileNavOpen && styles.drawerOpen)}>
        <aside data-dashboard-drawer="sidebar" className={styles.drawerSidebar}>
